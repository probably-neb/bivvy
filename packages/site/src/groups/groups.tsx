...
function GroupCard(props: { group: Group }) {
    ...
    return (
        <Card class="hover:scale-105 border-none w-64">
            <A href={routes.group(props.group.id)}>
                ...
                <CardContent class="pt-2 px-2 flex items-center justify-between">
                    <CardTitle class="text-xl whitespace-nowrap">{props.group.name}</CardTitle>
...
function NewGroupCard() {
    ...
    return (
        <><Card onClick={[setCreateGroupModalOpen, true]} class="w-64 col-span-full hover:scale-105 border-2 border-white flex items-center justify-center bg-white/50">
